...
public class _1Selenium1 {//инструмент для автоматизации Web тестирования .
    //с его помощью можно заменить рутиные операции (например текстовый ввод).

    //Selenium работает только в той часть экрана, которая видна на экране. Т.е. он не кликнет не кнопку если она не видна на экране.
